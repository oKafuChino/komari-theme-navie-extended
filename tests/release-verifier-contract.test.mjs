...
test('verifies the main theme by default and keeps the model pack out of CI release artifacts', async () => {
  ...
  assert.match(verifier, /process\.argv\.includes\('--model-pack'\)/)
})
